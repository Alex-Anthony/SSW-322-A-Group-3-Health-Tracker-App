                  ...
                  <div className="form-control w-full">
                    <label className="cursor-pointer label">
                      ...
                      <input
                        ...
                        onChange={(e) => setTempWeeklyReports(!weeklyReports)}
                      />
                    </label>
                  </div>
                  <div className="form-control w-full">
                    <label className="cursor-pointer label">
                      ...
                      <input
                        ...
                        onChange={(e) => setTempGoalReminders(!goalReminders)}
                      />
                    </label>
                  </div>
                  <div className="form-control w-full">
                    <label className="cursor-pointer label">
                      ...
                      <input
                        ...
                        onChange={(e) => setTempHealthAlerts(!healthAlerts)}
                      />
                    </label>
                  </div>
                </div>
                    ...
                    >
                      ...
                      <li>
                        <input
                          ...
                          value="cyberpunk"
                          onClick={(e) => setTempTheme("cyberpunk")}
                        />
                      </li>
                      <li>
                        <input
                          ...
                          value="valentine"
                          onClick={(e) => setTempTheme("valentine")}
                        />
                      </li>
                      <li>
                        <input
