    ...
    <div>
      <ul className="menu bg-base-200 w-16 h-screen rounded-box flex justify-center">
        <div>
          ...
          <li className="py-3 tooltip" data-tip="Health Data">
          ...
          <li className="py-3 tooltip" data-tip="Insights">
          ...
          <li className="py-3 tooltip" data-tip="Doctor's Portal">
          ...
          <li className="py-3 tooltip" data-tip="Log out">
            <Link href="/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
